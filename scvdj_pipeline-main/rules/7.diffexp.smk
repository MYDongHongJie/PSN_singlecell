rule  diffexp:
    ...
    benchmark:
        "benchmarks/diffexp_{diff_group}.benchmark.txt"
...
perl  scripts/enrichment/enrich_go_kegg.pl  \
    ...
    -thread 4  \
    -queue scrna |& tee {log}
find {params.outdir} -name "*" -type f -size 0c |xargs -n 1 rm -f  
        """
# =============================================================================================
...
-thread 2 -queue scrna && result/Diffexp/FC1.2/enrichment -name "*" -type f -size 0c |xargs -n 1 rm -f """)
