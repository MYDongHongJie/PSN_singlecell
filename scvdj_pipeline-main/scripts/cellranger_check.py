...
def cellranger_check(scrna,cellranger_only,tcr,bcr,Estimated_Number_of_Cells,Q30_Base_in_RNA_Read,Fraction_Reads_in_Cells,Median_Genes_per_Cell,Number_of_Reads,Reads_Mapped_Confidently_to_Transcriptome,Project_Num,Species,Customer,Project_management,Laboratory,include_introns):
    """
...
if __name__ == '__main__':
    ...
    (info,header)=cellranger_check(scrna,cellranger_only,tcr,bcr,Estimated_Number_of_Cells,Q30_Base_in_RNA_Read,Fraction_Reads_in_Cells,Median_Genes_per_Cell,Number_of_Reads,Reads_Mapped_Confidently_to_Transcriptome,Project_Num,Species,Customer,Project_management,Laboratory,include_introns)
