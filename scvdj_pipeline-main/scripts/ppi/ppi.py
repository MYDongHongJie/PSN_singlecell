...
def main(inputfile, species, prefix, noft, outputdir):
    ...
    if results_data.shape[0]>1:
        if "Regulation" in diffgene.columns:
            ...
            downtop_diff = diffgene[diffgene['Regulation']=="Down"].sort_values(by="FoldChange",ascending=False)[len(diffgene[diffgene['Regulation']=="Down"])-noft:len(diffgene[diffgene['Regulation']=="Down"])]
        ...
        cairosvg.svg2png(url=prefix + ".string_protein-protein-interaction.svg",
                    write_to=prefix + ".string_protein-protein-interaction.png",dpi=300)
