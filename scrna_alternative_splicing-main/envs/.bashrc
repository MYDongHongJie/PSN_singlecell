...
alias mlns="cp -r scrna_alternative_splicing/config . && ln -s scrna_alternative_splicing/{scripts,Snakefile,rules} ."
#====================================modulefiles load ==================================================================
#module load OESingleCell/v_3.0.0_visium_produce
export DRMAA_LIBRARY_PATH=/software/gridengine/lib/lx-amd64/libdrmaa.so
export PATH=/public/dev_scRNA/software/miniconda3/envs/OESingleCell_AlternativeSplicing/bin:$PATH
#export PATH=/public/dev_scRNA/software/miniconda3/bin:$PATH
source /public/dev_scRNA/software/miniconda3/etc/profile.d/conda.sh
#====================================snakemake function=================================================================

pwd=$(pwd -P)
feature=$(echo $pwd | awk -F '/' '{print $2}')
if [[ $feature == 'gpfs' ]]; then
    queue="scrna"
else
	queue="big"
fi
...
#======================= snakemake test
smt () {
snakemake -npr --rerun-triggers mtime -s $1
 }
