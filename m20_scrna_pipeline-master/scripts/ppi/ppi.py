...
def main(inputfile, species, prefix, noft, outputdir):
    ...
    if results_data.shape[0]>1:
        if "up_down" in diffgene.columns:
            ...
            downtop_diff = diffgene[diffgene['up_down']=="Down"].sort_values(by="FoldChange",ascending=False)[len(diffgene[diffgene['up_down']=="Down"])-noft:len(diffgene[diffgene['up_down']=="Down"])]
