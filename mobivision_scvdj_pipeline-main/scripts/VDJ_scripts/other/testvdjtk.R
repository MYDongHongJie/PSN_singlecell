...
vdj_profile = Sys.glob(file.path(input_path,paste0(assay_metadata$sampleid,"_",type_path),"outs",paste0(assay_metadata$sampleid,"_",type_path,"_filtered_contig_annotations.csv")))
