...
option_list = list(
    make_option( c( "--inputdir","-i"), type = "character",default = "result/mobivision",
        help = "the input dir."),
...
#input_path = normalizePath(file.path(dir,"mobivision"))
...
vdj_profile = Sys.glob(file.path(input_path,paste0(assay_metadata$Sample,"_",type),"outs",paste0(assay_metadata$Sample,"_",type,"_","filtered_contig_annotations.csv")))
