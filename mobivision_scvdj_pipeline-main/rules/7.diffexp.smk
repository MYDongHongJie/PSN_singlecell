...
Rscript {script_dir}/scVis \
  ...
  """)
                # ========== step3. ppi ==========  
                shell("module load {module} && python scripts/ppi/ppi.py -i {sig_file} -p {prefix} -o result/Diffexp/FC1.2/ppi -s {stringid} && Rscript  scripts/ppi/ppi_circle.r     -i result/Diffexp/FC1.2/ppi/{diff_group}-diff-pval-0.05-FC-1.2.ppi_network.tsv   -d {sig_file}    -o result/Diffexp/FC1.2/ppi") 
