    ...
    var defaults = {
      ...
      pdfmake: {
        ...
        docDefinition: {
          ...
          defaultStyle: {
            font: 'simhei'     // Default is 'Roboto', for arabic font set this option to 'Mirza' and include mirza_fonts.js
          }, 
          // pageSize: 'b3'
        },
        fonts: {}
        ...
        $rows.each(function () {
          ...
          ForEachVisibleCell(this, rowselector, rowIndex, length + $rows.length,
                             function (cell, row, col) {
                               //把txt的逗号(',')换成空格(' ')
                               trData += csvString(cell, row, col) + ((defaults.type === 'tsv' || defaults.type === 'txt') ? '\t' : defaults.csvSeparator);
