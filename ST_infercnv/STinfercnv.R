...
argv <- add_argument(argv,"--rdspath",help="the path of rds",default = "/PERSONALBIO/work/singlecell/s05/czscript/ST/STCellchat/HD.rds")
...
argv <- add_argument(argv,"--ref_celltype",help="reference of celltype",default="1,2")
...
argv <- add_argument(argv,"--outdir",help="the path of output",default="./infercnvV3")
argv <- add_argument(argv,"--tree",help="..",default=FALSE)
...
matrix<-as.matrix(sc@assays$SCT$counts)
