...
rule report:
    ...
    shell:
        """
rm -rf {params.report}
module purge && /public/scRNA_works/works/luyao/test/miniconda3/envs/cloudreport/bin/python scripts/report_BD/scRNA_report.py \
  -i result \
  -c {params.config} \
...
rule report_upload:
    ...
    shell:
        """
cd result/report/ ; 
/home/lipeng/miniconda3/bin/zip -r {params.report}.zip {params.report} ;
