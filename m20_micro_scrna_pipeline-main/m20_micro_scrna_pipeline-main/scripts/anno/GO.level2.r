...
option_list = list(
	make_option(c("--bpGOterm"), type="character", default=NULL, help="input file", metavar="character"),
	make_option(c("--mfGOterm"), type="character", default=NULL, help="input file", metavar="character"),
	make_option(c("--ccGOterm"), type="character", default=NULL, help="input file", metavar="character"),
	make_option(c("--level2"), type="character", default=NULL, help="input file", metavar="character")
);
