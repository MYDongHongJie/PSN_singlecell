...
my $blast="/public/dev_scRNA/software/conda_envs/OESingleCell_atac/bin/";
$threads||=10;
$evalue||="1e-10";
...
my %hash=();
open IN,"/data/database/scMicro_refdata/CARD/aro_index.tsv" or die "please check out the aro_index.tsv\n";
while(<IN>){
	chomp;
